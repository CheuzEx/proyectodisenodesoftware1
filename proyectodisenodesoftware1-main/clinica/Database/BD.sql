...
-- Converted COPY data to INSERT statements
INSERT INTO clinica.doc_especialidad (id_doctor, id_especialidad) VALUES (1, 1);

INSERT INTO clinica.doctor (id_doctor, nombre, apellido, direccion, telefono) VALUES (1, 'Daniel', 'Barboza', 'Avenida Central, Cartago', '8888-0000');
...
-- No data for cita, historial_medico, receta → COPY lines removed entirely
