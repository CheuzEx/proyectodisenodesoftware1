...
public class HistorialMedico {
    ...
    @JoinColumn(name = "id_cita", unique = true, nullable = true)
    ...
    @Column(name = "diagnostico", columnDefinition = "TEXT", nullable = true)
    private String diagnostico; // Diagnóstico registrado en la cita

    @Column(name = "tratamiento", columnDefinition = "TEXT", nullable = true)
